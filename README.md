# MEVO  Fellow the Mapbox instructions to set up a basic Android app that displays a map. You’ll need to create a free Mapbox account to access the required keys.
